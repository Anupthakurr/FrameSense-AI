  ...
  return (
    <div className="p-6 max-w-4xl mx-auto shadow-2xl rounded-lg">
      ...
      <p>
        ...
        "our" used anywhere on this page shall mean <strong>Anup</strong>, whose
        registered/operational office is{" "}
        <strong>H- no 3, gali no 6, North West Delhi DELHI 110042</strong>.
      ...
      <h2 className="text-xl font-semibold mt-4">Usage Terms</h2>
      ...
      <p>
        ...
        information. We do not endorse these websites and are not responsible
        for their content.
      </p>

      <h2 className="text-xl font-semibold mt-4">Legal Compliance</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-4">Payment Authorization</h2>
      <p>
